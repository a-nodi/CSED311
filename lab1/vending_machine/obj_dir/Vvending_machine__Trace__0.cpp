...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+17,(vlSelf->vending_machine__DOT__input_total),32);
    bufp->chgIData(oldp+18,(vlSelf->vending_machine__DOT__output_total),32);
    bufp->chgIData(oldp+19,(vlSelf->vending_machine__DOT__return_total),32);
    bufp->chgIData(oldp+20,(vlSelf->vending_machine__DOT__wait_time),32);
}
